...
main_ebpf.out: main.cc main.h main_ebpf_z3.o measure/benchmark_ebpf.cc measure/benchmark_ebpf.h measure/meas_mh_bhv.h measure/meas_mh_bhv.cc $(SEARCH)win_select.cc $(SEARCH)win_select.h $(EBPF)win_select.cc $(EBPF)win_select.h $(SEARCH)mh_prog.cc $(SEARCH)mh_prog.h $(SEARCH)proposals.cc $(SEARCH)proposals.h $(ISA)prog.cc $(ISA)prog.h $(SEARCH)cost.cc $(SEARCH)cost.h $(SRC)inout.cc $(SRC)inout.h $(EBPF)inst_codegen.h $(EBPF)inst_codegen.cc $(EBPF)canonicalize.h $(EBPF)canonicalize.cc $(ISA)inst_header.h $(ISA)inst_header_basic.h $(ISA)inst.cc $(ISA)inst.h $(EBPF)inst.cc $(EBPF)inst.h  $(EBPF)inst_var.cc $(EBPF)inst_var.h $(VERIFY)validator.cc $(VERIFY)validator.h $(VERIFY)z3client.cc $(VERIFY)z3client.h $(VERIFY)cfg.cc $(VERIFY)cfg.h $(VERIFY)smt_prog.cc $(VERIFY)smt_prog.h $(ISA)inst_var.cc $(ISA)inst_var.h $(SRC)utils.cc $(SRC)utils.h
...
cost_test_ebpf.out: cost_z3_ebpf.o $(SEARCH)cost.cc $(SEARCH)cost.h $(ISA)prog.cc $(ISA)prog.h $(SRC)inout.cc $(SRC)inout.h $(EBPF)inst_codegen.h $(EBPF)inst_codegen.cc $(EBPF)canonicalize.h $(EBPF)canonicalize.cc $(ISA)inst_header.h $(ISA)inst_header_basic.h $(ISA)inst.cc $(ISA)inst.h $(EBPF)inst.cc $(EBPF)inst.h  $(EBPF)inst_var.cc $(EBPF)inst_var.h $(VERIFY)validator.cc $(VERIFY)validator.h $(VERIFY)z3client.cc $(VERIFY)z3client.h $(VERIFY)cfg.cc $(VERIFY)cfg.h $(VERIFY)smt_prog.cc $(VERIFY)smt_prog.h $(ISA)inst_var.cc $(ISA)inst_var.h $(SRC)utils.cc $(SRC)utils.h measure/benchmark_ebpf.h measure/benchmark_ebpf.cc
	g++ $(EBPF_FLAG) -std=c++11 $(SEARCH)cost_z3_ebpf.o $(ISA)inst.cc $(EBPF)inst.cc $(EBPF)inst_var.cc $(ISA)prog.cc $(SEARCH)cost.cc $(SRC)inout.cc $(EBPF)inst_codegen.cc $(EBPF)canonicalize.cc $(VERIFY)validator.cc $(VERIFY)z3client.cc $(VERIFY)cfg.cc $(VERIFY)smt_prog.cc $(ISA)inst_var.cc $(SRC)utils.cc measure/benchmark_ebpf.cc -o $(SEARCH)cost_test_ebpf.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
...
validator_test_ebpf.out: validator_z3_ebpf.o $(VERIFY)validator.cc $(VERIFY)validator.h $(VERIFY)z3client.cc $(VERIFY)z3client.h $(EBPF)inst.cc $(EBPF)inst.h $(EBPF)inst_var.cc $(EBPF)inst_var.h $(VERIFY)cfg.cc $(VERIFY)cfg.h $(SRC)inout.cc $(SRC)inout.h $(SRC)utils.cc $(SRC)utils.h $(VERIFY)smt_prog.cc $(VERIFY)smt_prog.h $(ISA)inst_var.cc $(ISA)inst_var.h $(ISA)prog.cc $(ISA)prog.h $(EBPF)inst_codegen.h $(EBPF)inst_codegen.cc $(EBPF)canonicalize.cc $(EBPF)canonicalize.h $(ISA)inst_header.h $(ISA)inst_header_basic.h $(ISA)inst.cc $(ISA)inst.h measure/benchmark_ebpf.h measure/benchmark_ebpf.cc
	g++ $(EBPF_FLAG) -std=c++11 -fvisibility=hidden $(VERIFY)validator_z3_ebpf.o $(VERIFY)validator.cc $(VERIFY)z3client.cc $(EBPF)inst.cc $(EBPF)inst_var.cc $(VERIFY)cfg.cc $(SRC)inout.cc $(SRC)utils.cc $(VERIFY)smt_prog.cc $(ISA)inst_var.cc  $(ISA)prog.cc $(EBPF)inst_codegen.cc $(EBPF)canonicalize.cc $(ISA)inst.cc measure/benchmark_ebpf.cc -o $(VERIFY)validator_test_ebpf.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
...
canonicalize_test_ebpf.out: canonicalize_z3_ebpf.o $(EBPF)canonicalize.cc $(EBPF)canonicalize.h $(EBPF)inst.cc $(EBPF)inst.h $(EBPF)bpf.h $(SRC)utils.cc $(SRC)utils.h $(EBPF)inst_codegen.cc $(EBPF)inst_codegen.h $(EBPF)inst_var.cc $(EBPF)inst_var.h $(ISA)inst.cc $(ISA)inst.h $(ISA)inst_var.cc $(ISA)inst_var.h $(VERIFY)cfg.cc $(VERIFY)cfg.h $(ISA)inst_header_basic.h measure/benchmark_ebpf.h measure/benchmark_ebpf.cc
	g++ $(EBPF_FLAG) -std=c++11 -fvisibility=hidden $(EBPF)canonicalize_z3_ebpf.o $(EBPF)canonicalize.cc $(EBPF)inst.cc $(SRC)utils.cc $(EBPF)inst_codegen.cc $(EBPF)inst_var.cc $(ISA)inst.cc $(ISA)inst_var.cc $(VERIFY)cfg.cc measure/benchmark_ebpf.cc -o $(EBPF)canonicalize_test_ebpf.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
...
win_select_test_ebpf.out: win_select_z3_ebpf.o $(SEARCH)win_select.cc $(SEARCH)win_select.h $(EBPF)win_select.cc $(EBPF)win_select.h $(EBPF)canonicalize.cc $(EBPF)canonicalize.h $(EBPF)inst.cc $(EBPF)inst.h $(EBPF)bpf.h $(SRC)utils.cc $(SRC)utils.h $(EBPF)inst_codegen.cc $(EBPF)inst_codegen.h $(EBPF)inst_var.cc $(EBPF)inst_var.h $(ISA)inst.cc $(ISA)inst.h $(ISA)inst_var.cc $(ISA)inst_var.h $(VERIFY)cfg.cc $(VERIFY)cfg.h $(ISA)inst_header_basic.h measure/benchmark_ebpf.h measure/benchmark_ebpf.cc
	g++ $(EBPF_FLAG) -std=c++11 -fvisibility=hidden $(SEARCH)win_select_z3_ebpf.o $(SEARCH)win_select.cc $(EBPF)win_select.cc $(EBPF)canonicalize.cc $(EBPF)inst.cc $(SRC)utils.cc $(EBPF)inst_codegen.cc $(EBPF)inst_var.cc $(ISA)inst.cc $(ISA)inst_var.cc $(VERIFY)cfg.cc measure/benchmark_ebpf.cc -o $(SEARCH)win_select_test_ebpf.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
...
win_select_test_ebpf_isa.out: win_select_z3_ebpf_isa.o $(EBPF)win_select.cc $(EBPF)win_select.h $(EBPF)canonicalize.cc $(EBPF)canonicalize.h $(EBPF)inst.cc $(EBPF)inst.h $(EBPF)bpf.h $(SRC)utils.cc $(SRC)utils.h $(EBPF)inst_codegen.cc $(EBPF)inst_codegen.h $(EBPF)inst_var.cc $(EBPF)inst_var.h $(ISA)inst.cc $(ISA)inst.h $(ISA)inst_var.cc $(ISA)inst_var.h $(VERIFY)cfg.cc $(VERIFY)cfg.h $(ISA)inst_header_basic.h measure/benchmark_ebpf.h measure/benchmark_ebpf.cc
	g++ $(EBPF_FLAG) -std=c++11 -fvisibility=hidden $(EBPF)win_select_z3.o $(EBPF)win_select.cc $(EBPF)canonicalize.cc $(EBPF)inst.cc $(SRC)utils.cc $(EBPF)inst_codegen.cc $(EBPF)inst_var.cc $(ISA)inst.cc $(ISA)inst_var.cc $(VERIFY)cfg.cc measure/benchmark_ebpf.cc -o $(EBPF)win_select_test.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
