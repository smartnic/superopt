...
main_ebpf.out: main.cc main.h main_ebpf_z3.o measure/benchmark_ebpf.cc measure/benchmark_ebpf.h measure/meas_mh_bhv.h measure/meas_mh_bhv.cc $(SEARCH)win_select.cc $(SEARCH)win_select.h $(EBPF)win_select.cc $(EBPF)win_select.h $(SEARCH)mh_prog.cc $(SEARCH)mh_prog.h $(SEARCH)proposals.cc $(SEARCH)proposals.h $(ISA)prog.cc $(ISA)prog.h $(SEARCH)cost.cc $(SEARCH)cost.h $(SRC)inout.cc $(SRC)inout.h $(EBPF)inst_codegen.h $(EBPF)inst_codegen.cc $(EBPF)canonicalize.h $(EBPF)canonicalize.cc $(ISA)inst_header.h $(ISA)inst_header_basic.h $(ISA)inst.cc $(ISA)inst.h $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst.h  $(EBPF)inst_var.cc $(EBPF)inst_var.h $(VERIFY)validator.cc $(VERIFY)validator.h $(VERIFY)z3client.cc $(VERIFY)z3client.h $(VERIFY)cfg.cc $(VERIFY)cfg.h $(VERIFY)smt_prog.cc $(VERIFY)smt_prog.h $(ISA)inst_var.cc $(ISA)inst_var.h $(SRC)utils.cc $(SRC)utils.h
	g++ $(EBPF_FLAG) -std=c++11 main_ebpf_z3.o measure/benchmark_ebpf.cc measure/meas_mh_bhv.cc $(SEARCH)win_select.cc $(EBPF)win_select.cc $(ISA)inst.cc $(EBPF)inst.cc $(EBPF)bpf.cc  $(EBPF)inst_var.cc $(SEARCH)mh_prog.cc $(SEARCH)proposals.cc $(ISA)prog.cc $(SEARCH)cost.cc $(SRC)inout.cc $(EBPF)inst_codegen.cc $(EBPF)canonicalize.cc $(VERIFY)validator.cc $(VERIFY)z3client.cc $(VERIFY)cfg.cc $(VERIFY)smt_prog.cc $(ISA)inst_var.cc $(SRC)utils.cc  -o main_ebpf.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
...
ebpf_inst_test.out: ebpf_inst_z3.o $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst.h $(EBPF)bpf.h $(SRC)utils.cc $(SRC)utils.h $(EBPF)inst_codegen.h $(EBPF)inst_codegen.cc $(EBPF)inst_var.cc $(EBPF)inst_var.h $(ISA)inst_header.h $(ISA)inst_header_basic.h $(ISA)inst.cc $(ISA)inst.h $(ISA)inst_var.cc $(ISA)inst_var.h
	g++ $(EBPF_FLAG) -std=c++11 -fvisibility=hidden $(EBPF)inst_z3.o $(EBPF)inst.cc $(EBPF)bpf.cc $(SRC)utils.cc $(EBPF)inst_codegen.cc $(EBPF)inst_var.cc $(ISA)inst.cc $(ISA)inst_var.cc -o $(EBPF)inst_test.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
...
cost_test_ebpf.out: cost_z3_ebpf.o $(SEARCH)cost.cc $(SEARCH)cost.h $(ISA)prog.cc $(ISA)prog.h $(SRC)inout.cc $(SRC)inout.h $(EBPF)inst_codegen.h $(EBPF)inst_codegen.cc $(EBPF)canonicalize.h $(EBPF)canonicalize.cc $(ISA)inst_header.h $(ISA)inst_header_basic.h $(ISA)inst.cc $(ISA)inst.h $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst.h  $(EBPF)inst_var.cc $(EBPF)inst_var.h $(VERIFY)validator.cc $(VERIFY)validator.h $(VERIFY)z3client.cc $(VERIFY)z3client.h $(VERIFY)cfg.cc $(VERIFY)cfg.h $(VERIFY)smt_prog.cc $(VERIFY)smt_prog.h $(ISA)inst_var.cc $(ISA)inst_var.h $(SRC)utils.cc $(SRC)utils.h measure/benchmark_ebpf.h measure/benchmark_ebpf.cc
	g++ $(EBPF_FLAG) -std=c++11 $(SEARCH)cost_z3_ebpf.o $(ISA)inst.cc $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst_var.cc $(ISA)prog.cc $(SEARCH)cost.cc $(SRC)inout.cc $(EBPF)inst_codegen.cc $(EBPF)canonicalize.cc $(VERIFY)validator.cc $(VERIFY)z3client.cc $(VERIFY)cfg.cc $(VERIFY)smt_prog.cc $(ISA)inst_var.cc $(SRC)utils.cc measure/benchmark_ebpf.cc -o $(SEARCH)cost_test_ebpf.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
...
prog_test_ebpf.out: prog_z3_ebpf.o $(ISA)prog.cc $(EBPF)inst_codegen.h $(EBPF)inst_codegen.cc $(ISA)inst_header.h $(ISA)inst_header_basic.h $(ISA)inst.cc $(ISA)inst.h $(EBPF)inst.h $(EBPF)inst.cc $(EBPF)bpf.cc $(ISA)inst_var.h $(ISA)inst_var.cc $(EBPF)inst_var.h $(EBPF)inst_var.cc $(ISA)prog.h $(SRC)utils.h $(SRC)utils.cc
	g++ $(EBPF_FLAG) -std=c++11 $(ISA)prog_z3_ebpf.o $(ISA)prog.cc $(EBPF)inst_codegen.cc $(ISA)inst.cc $(EBPF)inst.cc $(EBPF)bpf.cc $(ISA)inst_var.cc $(EBPF)inst_var.cc $(SRC)utils.cc -o $(ISA)prog_test_ebpf.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
...
validator_test_ebpf.out: validator_z3_ebpf.o $(VERIFY)validator.cc $(VERIFY)validator.h $(VERIFY)z3client.cc $(VERIFY)z3client.h $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst.h $(EBPF)inst_var.cc $(EBPF)inst_var.h $(VERIFY)cfg.cc $(VERIFY)cfg.h $(SRC)inout.cc $(SRC)inout.h $(SRC)utils.cc $(SRC)utils.h $(VERIFY)smt_prog.cc $(VERIFY)smt_prog.h $(ISA)inst_var.cc $(ISA)inst_var.h $(ISA)prog.cc $(ISA)prog.h $(EBPF)inst_codegen.h $(EBPF)inst_codegen.cc $(EBPF)canonicalize.cc $(EBPF)canonicalize.h $(ISA)inst_header.h $(ISA)inst_header_basic.h $(ISA)inst.cc $(ISA)inst.h measure/benchmark_ebpf.h measure/benchmark_ebpf.cc
	g++ $(EBPF_FLAG) -std=c++11 -fvisibility=hidden $(VERIFY)validator_z3_ebpf.o $(VERIFY)validator.cc $(VERIFY)z3client.cc $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst_var.cc $(VERIFY)cfg.cc $(SRC)inout.cc $(SRC)utils.cc $(VERIFY)smt_prog.cc $(ISA)inst_var.cc  $(ISA)prog.cc $(EBPF)inst_codegen.cc $(EBPF)canonicalize.cc $(ISA)inst.cc measure/benchmark_ebpf.cc -o $(VERIFY)validator_test_ebpf.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
...
smt_prog_test_ebpf.out: smt_prog_z3_ebpf.o $(VERIFY)smt_prog.cc $(VERIFY)smt_prog.h $(ISA)inst_var.cc $(ISA)inst_var.h $(EBPF)inst_codegen.h $(EBPF)inst_codegen.cc $(ISA)inst_header.h $(ISA)inst_header_basic.h $(ISA)inst.cc $(ISA)inst.h $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst.h $(EBPF)inst_var.cc $(EBPF)inst_var.h $(VERIFY)cfg.cc $(VERIFY)cfg.h $(SRC)utils.cc $(SRC)utils.h
	g++ $(EBPF_FLAG) -std=c++11 -fvisibility=hidden $(VERIFY)smt_prog_z3_ebpf.o $(VERIFY)smt_prog.cc $(ISA)inst_var.cc $(EBPF)inst_codegen.cc $(ISA)inst.cc $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst_var.cc $(VERIFY)cfg.cc $(SRC)utils.cc -o $(VERIFY)smt_prog_test_ebpf.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
...
cfg_test_ebpf.out: cfg_z3_ebpf.o $(EBPF)inst_codegen.h $(EBPF)inst_codegen.cc $(ISA)inst_header_basic.h $(ISA)inst.cc $(ISA)inst.h $(EBPF)inst.h $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst_var.h $(EBPF)inst_var.cc $(VERIFY)cfg.h $(VERIFY)cfg.cc $(SRC)utils.cc $(SRC)utils.h $(ISA)inst_var.cc $(ISA)inst_var.h
	g++ $(EBPF_FLAG) -std=c++11 $(EBPF)inst_codegen.cc $(ISA)inst.cc $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst_var.cc $(VERIFY)cfg.cc $(VERIFY)cfg_z3_ebpf.o $(SRC)utils.cc $(ISA)inst_var.cc -o $(VERIFY)cfg_test_ebpf.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
...
canonicalize_test_ebpf.out: canonicalize_z3_ebpf.o $(EBPF)canonicalize.cc $(EBPF)canonicalize.h $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst.h $(EBPF)bpf.h $(SRC)utils.cc $(SRC)utils.h $(EBPF)inst_codegen.cc $(EBPF)inst_codegen.h $(EBPF)inst_var.cc $(EBPF)inst_var.h $(ISA)inst.cc $(ISA)inst.h $(ISA)inst_var.cc $(ISA)inst_var.h $(VERIFY)cfg.cc $(VERIFY)cfg.h $(ISA)inst_header_basic.h measure/benchmark_ebpf.h measure/benchmark_ebpf.cc
	g++ $(EBPF_FLAG) -std=c++11 -fvisibility=hidden $(EBPF)canonicalize_z3_ebpf.o $(EBPF)canonicalize.cc $(EBPF)inst.cc $(EBPF)bpf.cc $(SRC)utils.cc $(EBPF)inst_codegen.cc $(EBPF)inst_var.cc $(ISA)inst.cc $(ISA)inst_var.cc $(VERIFY)cfg.cc measure/benchmark_ebpf.cc -o $(EBPF)canonicalize_test_ebpf.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
...
win_select_test_ebpf.out: win_select_z3_ebpf.o $(SEARCH)win_select.cc $(SEARCH)win_select.h $(EBPF)win_select.cc $(EBPF)win_select.h $(EBPF)canonicalize.cc $(EBPF)canonicalize.h $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst.h $(EBPF)bpf.h $(SRC)utils.cc $(SRC)utils.h $(EBPF)inst_codegen.cc $(EBPF)inst_codegen.h $(EBPF)inst_var.cc $(EBPF)inst_var.h $(ISA)inst.cc $(ISA)inst.h $(ISA)inst_var.cc $(ISA)inst_var.h $(VERIFY)cfg.cc $(VERIFY)cfg.h $(ISA)inst_header_basic.h measure/benchmark_ebpf.h measure/benchmark_ebpf.cc
	g++ $(EBPF_FLAG) -std=c++11 -fvisibility=hidden $(SEARCH)win_select_z3_ebpf.o $(SEARCH)win_select.cc $(EBPF)win_select.cc $(EBPF)canonicalize.cc $(EBPF)inst.cc $(EBPF)bpf.cc $(SRC)utils.cc $(EBPF)inst_codegen.cc $(EBPF)inst_var.cc $(ISA)inst.cc $(ISA)inst_var.cc $(VERIFY)cfg.cc measure/benchmark_ebpf.cc -o $(SEARCH)win_select_test_ebpf.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
...
win_select_test_ebpf_isa.out: win_select_z3_ebpf_isa.o $(EBPF)win_select.cc $(EBPF)win_select.h $(EBPF)canonicalize.cc $(EBPF)canonicalize.h $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst.h $(EBPF)bpf.h $(SRC)utils.cc $(SRC)utils.h $(EBPF)inst_codegen.cc $(EBPF)inst_codegen.h $(EBPF)inst_var.cc $(EBPF)inst_var.h $(ISA)inst.cc $(ISA)inst.h $(ISA)inst_var.cc $(ISA)inst_var.h $(VERIFY)cfg.cc $(VERIFY)cfg.h $(ISA)inst_header_basic.h measure/benchmark_ebpf.h measure/benchmark_ebpf.cc
	g++ $(EBPF_FLAG) -std=c++11 -fvisibility=hidden $(EBPF)win_select_z3.o $(EBPF)win_select.cc $(EBPF)canonicalize.cc $(EBPF)inst.cc $(EBPF)bpf.cc $(SRC)utils.cc $(EBPF)inst_codegen.cc $(EBPF)inst_var.cc $(ISA)inst.cc $(ISA)inst_var.cc $(VERIFY)cfg.cc measure/benchmark_ebpf.cc -o $(EBPF)win_select_test.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)

win_select_z3_ebpf_isa.o: $(EBPF)win_select_test.cc
	$(CXX) $(EBPF_FLAG) $(CXXFLAGS) $(OS_DEFINES) $(EXAMP_DEBUG_FLAG) $(CXX_OUT_FLAG)$(EBPF)win_select_z3.o  -I../z3/src/api -I../z3/src/api/c++ $(EBPF)win_select_test.cc
...
meas_time_ebpf.out: measure/meas_time_ebpf.cc measure/benchmark_ebpf.cc measure/benchmark_ebpf.h measure/meas_mh_bhv.h measure/meas_mh_bhv.cc meas_time_z3_ebpf.o $(SEARCH)mh_prog.cc $(SEARCH)mh_prog.h $(SEARCH)proposals.cc $(SEARCH)proposals.h $(ISA)prog.cc $(ISA)prog.h $(SEARCH)cost.cc $(SEARCH)cost.h $(SRC)inout.cc $(SRC)inout.h $(EBPF)inst_codegen.h $(EBPF)inst_var.h $(EBPF)inst_var.cc $(ISA)inst_header.h $(ISA)inst_header_basic.h $(EBPF)canonicalize.h $(EBPF)canonicalize.cc $(ISA)inst.cc $(ISA)inst.h $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst.h $(VERIFY)validator.cc $(VERIFY)validator.h $(VERIFY)z3client.cc $(VERIFY)z3client.h $(VERIFY)cfg.cc $(VERIFY)cfg.h $(VERIFY)smt_prog.cc $(VERIFY)smt_prog.h $(ISA)inst_var.cc $(ISA)inst_var.h $(SRC)utils.cc $(SRC)utils.h
	g++ $(EBPF_FLAG) -std=c++11 measure/meas_time_z3_ebpf.o measure/benchmark_ebpf.cc measure/meas_mh_bhv.cc $(ISA)inst.cc $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst_var.cc $(EBPF)canonicalize.cc $(SEARCH)mh_prog.cc $(SEARCH)proposals.cc $(ISA)prog.cc $(SEARCH)cost.cc $(SRC)inout.cc $(EBPF)inst_codegen.cc $(VERIFY)validator.cc $(VERIFY)z3client.cc $(VERIFY)cfg.cc $(VERIFY)smt_prog.cc $(ISA)inst_var.cc $(SRC)utils.cc -o measure/meas_time_ebpf.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
...
meas_solve_time_ebpf.out: measure/meas_solve_time_ebpf.cc measure/benchmark_ebpf.cc measure/benchmark_ebpf.h measure/meas_mh_bhv.h measure/meas_mh_bhv.cc meas_solve_time_z3_ebpf.o $(SEARCH)mh_prog.cc $(SEARCH)mh_prog.h $(SEARCH)proposals.cc $(SEARCH)proposals.h $(ISA)prog.cc $(ISA)prog.h $(SEARCH)cost.cc $(SEARCH)cost.h $(SRC)inout.cc $(SRC)inout.h $(EBPF)inst_codegen.h $(EBPF)inst_var.h $(EBPF)inst_var.cc $(ISA)inst_header.h $(ISA)inst_header_basic.h $(EBPF)canonicalize.h $(EBPF)canonicalize.cc $(ISA)inst.cc $(ISA)inst.h $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst.h $(VERIFY)validator.cc $(VERIFY)validator.h $(VERIFY)cfg.cc $(VERIFY)cfg.h $(VERIFY)smt_prog.cc $(VERIFY)smt_prog.h $(ISA)inst_var.cc $(ISA)inst_var.h $(SRC)utils.cc $(SRC)utils.h $(VERIFY)z3client.cc $(VERIFY)z3client.h
	g++ $(EBPF_FLAG) -std=c++11 measure/meas_solve_time_z3_ebpf.o measure/benchmark_ebpf.cc measure/meas_mh_bhv.cc $(ISA)inst.cc $(EBPF)inst.cc $(EBPF)bpf.cc $(EBPF)inst_var.cc $(EBPF)canonicalize.cc $(SEARCH)mh_prog.cc $(SEARCH)proposals.cc $(ISA)prog.cc $(SEARCH)cost.cc $(SRC)inout.cc $(EBPF)inst_codegen.cc $(VERIFY)validator.cc $(VERIFY)cfg.cc $(VERIFY)smt_prog.cc $(ISA)inst_var.cc $(SRC)utils.cc $(VERIFY)z3client.cc -o measure/meas_solve_time_ebpf.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
