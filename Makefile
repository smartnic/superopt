...
validator_test.out: validator_z3.o validator.cc inst.cc cfg.h cfg.cc inout.cc
	g++ -std=c++11 validator_z3.o validator.cc inst.cc cfg.cc inout.cc -o validator_test.out ../z3/build/libz3.dylib -lpthread
