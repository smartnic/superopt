all: proposals_test.out inst_test.out cost_test.out prog_test.out mh_prog.out
...
mh_prog.out: mh_prog.cc mh_prog.h mh_prog_test.cc proposals_test.out prog_test.out cost_test.out
	g++ -std=c++11 inst.cc mh_prog.cc proposals.cc prog.cc cost.cc mh_prog_test.cc inout.cc -o mh_prog_test.out

clean:
	rm -f proposals_test.out inst_test.out cost_test.out prog_test.out mh_prog.out
