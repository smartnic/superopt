...
mh_prog_test.out: mh_prog.cc mh_prog.h mh_prog_test.cc proposals.cc proposals.h prog.cc prog.h cost.cc cost.h inout.cc inout.h inst.cc inst.h ex.cc ex.h validator.cc validator.h cfg.cc cfg.h mh_prog_z3.o
	g++ -std=c++11 inst.cc mh_prog.cc proposals.cc prog.cc cost.cc inout.cc ex.cc validator.cc cfg.cc mh_prog_z3.o -o mh_prog_test.out ../z3/build/libz3.dylib -lpthread
