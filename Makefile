...
meas_mh_bhv_test.out: meas_mh_bhv_z3.o measure/meas_mh_bhv.h measure/meas_mh_bhv.cc measure/common.h measure/common.cc $(ISA)prog.h $(ISA)prog.cc $(SRC)inout.h $(SRC)inout.cc $(ISA)inst_codegen.cc $(ISA)inst_codegen.h $(ISA)inst.cc  $(ISA)inst.h $(TOY_ISA)inst.h $(TOY_ISA)inst.cc $(VERIFY)smt_var.cc $(VERIFY)smt_var.h $(SRC)utils.cc $(SRC)utils.h
	g++ -std=c++11 measure/meas_mh_bhv_z3.o measure/meas_mh_bhv.cc measure/common.cc $(ISA)prog.cc $(SRC)inout.cc $(ISA)inst_codegen.cc $(ISA)inst.cc $(TOY_ISA)inst.cc $(VERIFY)smt_var.cc $(SRC)utils.cc -o measure/meas_mh_bhv_test.out ../z3/build/libz3$(SO_EXT) $(LINK_EXTRA_FLAGS)
