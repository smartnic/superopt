...
// bpf inst to bpf c macro strings
// 1. bpf inst program does not contain real NOP
// 2. bpf inst is the inst data structure after convert_superopt_pgm_to_bpf_pgm()
// eg. movdwxc r0 imm64:
// insn 1: inst(LDDW, 0, dst_reg, 0, uint32_t(uint64_t(imm64))),
// insn 2: inst(0, 0, 0, 0, uint64_t(imm64) >> 32)
