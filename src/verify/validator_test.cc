...
void test1() {
  ...
  toy_isa_inst instructions1[6] = {toy_isa_inst(MOVXC, 1, 4),     /* mov r1, 4  */
                                   toy_isa_inst(ADDXY, 0, 1),     /* add r0, r1 */
                                   toy_isa_inst(MOVXC, 2, 15),    /* mov r2, 15 */
                                   toy_isa_inst(MAXC, 0, 15),     /* max r0, 15 */
                                   toy_isa_inst(MAXX, 0, 1),      /* max r0, r1 */
                                   toy_isa_inst(RETX, 0),
                                  };

  toy_isa_inst instructions2[7] = {toy_isa_inst(MOVXC, 1, 4),     /* mov r1, 4  */
                                   toy_isa_inst(MOVXC, 2, 10),    /* mov r2, 10 */
                                   toy_isa_inst(ADDXY, 0, 1),     /* add r0, r1 */
                                   toy_isa_inst(MOVXC, 2, 15),    /* mov r2, 15 */
                                   toy_isa_inst(MAXC, 0, 15),     /* max r0, 15 */
                                   toy_isa_inst(MAXX, 0, 1),      /* max r0, r1 */
  ...
  toy_isa_inst instructions3[5] = {toy_isa_inst(MOVXC, 1, 4),     /* mov r1, 4  */
                                   toy_isa_inst(ADDXY, 0, 1),     /* add r0, r1 */
                                   toy_isa_inst(MOVXC, 2, 15),    /* mov r2, 15 */
                                   toy_isa_inst(MAXC, 0, 15),     /* max r0, 15 */
                                   toy_isa_inst(MAXX, 0, 2),      /* max r0, r2 */
                                  };                      // default: ret 0

  toy_isa_inst instructions4[6] = {toy_isa_inst(MOVXC, 1, 4),     /* mov r1, 4  */
                                   toy_isa_inst(ADDXY, 0, 1),     /* add r0, r1 */
                                   toy_isa_inst(MOVXC, 2, 15),    /* mov r2, 15 */
                                   toy_isa_inst(MAXC, 0, -1),     /* max r0, 15 */
                                   toy_isa_inst(MAXX, 0, 3),      /* max r0, r3 */
                                   toy_isa_inst(RETX, 0),
                                  };
...
void test2() {
  ...
  toy_isa_inst instructions1[3] = {toy_isa_inst(JMPGT, 0, 2, 1),  // if r0 <= r2:
                                   toy_isa_inst(RETX, 0),         // ret r0
                                   toy_isa_inst(RETX, 2),         // ret r2;
                                  };
  toy_isa_inst instructions2[3] = {toy_isa_inst(JMPLT, 0, 2, 1),  // if r0 >= r2
                                   toy_isa_inst(RETX, 2),         // ret r2
                                   toy_isa_inst(RETX, 0),         // ret r0
                                  };
  ...
  toy_isa_inst instructions3[3] = {toy_isa_inst(JMPGT, 0, 2, 1),  // return max(r0, r2)
                                   toy_isa_inst(RETX, 2),
                                   toy_isa_inst(RETX, 0),
                                  };
  toy_isa_inst instructions4[2] = {toy_isa_inst(MAXX, 0, 2),      // return r0=max(r0, r2)
                                   toy_isa_inst(RETX, 0),
                                  };
  toy_isa_inst instructions5[3] = {toy_isa_inst(JMPGT, 2, 0, 1),  // return min(r0, r2)
                                   toy_isa_inst(RETX, 2),
                                   toy_isa_inst(RETX, 0),
                                  };
  ...
  // f(x) = max(x, r1, r2, 10)
  // p11 == p12
  toy_isa_inst p11[5] = {toy_isa_inst(MAXX, 0, 1),
                         toy_isa_inst(MAXX, 0, 2),
                         toy_isa_inst(MOVXC, 1, 10),
                         toy_isa_inst(MAXX, 0, 1),
                         toy_isa_inst(RETX, 0),
                        };
  toy_isa_inst p12[11] = {toy_isa_inst(JMPGT, 0, 1, 2), // skip r0 <- r1, if r0 > r1
                          toy_isa_inst(MOVXC, 0, 0),
                          toy_isa_inst(ADDXY, 0, 1),
                          toy_isa_inst(JMPGT, 0, 2, 2), // skip r0 <- r2, if r0 > r2
                          toy_isa_inst(MOVXC, 0, 0),
                          toy_isa_inst(ADDXY, 0, 2),
                          toy_isa_inst(MOVXC, 1, 10),   // r1 <- 10
                          toy_isa_inst(JMPGT, 0, 1, 2), // skip r0 <- r1, if r0 > r1
                          toy_isa_inst(MOVXC, 0, 0),
                          toy_isa_inst(ADDXY, 0, 1),
                          toy_isa_inst(RETX, 0),        // ret r0
                         };
  ...
  // p13 != p11, p14 == p15 == p11
  toy_isa_inst p13[6] = {toy_isa_inst(JMP, 3),
                         toy_isa_inst(MAXX, 0, 1),
                         toy_isa_inst(MAXX, 0, 2),
                         toy_isa_inst(MOVXC, 1, 10),
                         toy_isa_inst(MAXX, 0, 1),
  ...
  toy_isa_inst p14[6] = {toy_isa_inst(JMP, 0),
                         toy_isa_inst(MAXX, 0, 1),
                         toy_isa_inst(MAXX, 0, 2),
                         toy_isa_inst(MOVXC, 1, 10),
                         toy_isa_inst(MAXX, 0, 1),
  ...
  toy_isa_inst p15[7] = {toy_isa_inst(JMP, 3),
                         toy_isa_inst(MOVXC, 1, 10),
                         toy_isa_inst(MAXX, 0, 1),
                         toy_isa_inst(RETX, 0),
                         toy_isa_inst(MAXX, 0, 1),
...
void test3() {
  ...
  toy_isa_inst p_fx[4] = {toy_isa_inst(MOVXC, 1, 10),
                          toy_isa_inst(JMPLT, 0, 1, 1),
                          toy_isa_inst(RETX, 0),
                          toy_isa_inst(RETX, 1),
                         };
...
void test4() {
  ...
  toy_isa_inst orig[3] = {toy_isa_inst(MOVXC, 2, 11),    /* mov r2, 11 */
                          toy_isa_inst(MAXX, 0, 2),      /* max r0, r2 */
                          toy_isa_inst(RETX, 0),
                         };
  toy_isa_inst synth[3] = {toy_isa_inst(MOVXC, 2, 10),    /* mov r2, 10 */
                           toy_isa_inst(MAXX, 0, 2),      /* max r0, r2 */
                           toy_isa_inst(RETX, 0),
                          };
