#!/bin/bash
path_prefix=experiments/2_change_benchmark/1_k2_inst/
...
cd ../../../
./input_translater/k2_inst_translater.out $path_prefix$benchmark experiments/2_change_benchmark/1_k2_inst/benchmark.insns
echo "Running K2 to optimize benchmark..."
./main_ebpf.out --bm_from_file --desc experiments/2_change_benchmark/1_k2_inst/benchmark.desc --bytecode experiments/2_change_benchmark/1_k2_inst/benchmark.insns --map experiments/2_change_benchmark/1_k2_inst/benchmark.maps -k 1 --is_win --port 8000 --logger_level 1 --w_e 0.5 --w_p 1.5 --st_ex 0 --st_eq 0 --st_avg 1 --st_perf 0 --st_when_to_restart 0 --st_when_to_restart_niter 0 --st_start_prog 0 --p_inst_operand 0.33333333 --p_inst 0.33333333 --p_inst_as_nop 0.15 --reset_win_niter 5000 --win_s_list 0 --win_e_list 3 --path_res experiments/2_change_benchmark/1_k2_inst/output/ -n 50000 > experiments/2_change_benchmark/1_k2_inst/output/log.txt
cd experiments/2_change_benchmark/1_k2_inst
echo "Finish running:"
